...
Right.1.sec=__ droit d’accès (article 15 du {_RGPD}) ; 

Right.2.sec=__ droit de rectification (article 16 du {_RGPD}) ; 

Right.3.sec=__ droit à l’effacement (article 17 du {_RGPD}) ; 

Right.4.sec=__ droit à la limitation du traitement (article 18 du {_RGPD}) ; 

Right.5.sec=__ droit à la portabilité (article 20 du {_RGPD}) ; 

Right.6.sec=__ droit d’opposition (article 21 du {_RGPD}) ; 

Right.7.sec=__ droit d’obtenir une intervention humaine (article 22 du {_RGPD}) ; 

Right.8.sec=__ droit de retirer mon consentement (article 7 du {_RGPD}). 
